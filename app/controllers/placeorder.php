...
function generate_new_transaction_number() {
    ...
    //make sure to input correct path
        ->setReturnUrl('https://breadpitt.herokuapp.com/app/controllers/pay.php?success=true')
        ->setCancelUrl('https://breadpitt.herokuapp.com/app/controllers/pay.php?success=false');
        //===========================================
