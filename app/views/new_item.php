...
<div class="container">
	<section class="newitem-page my-5">
		<div class="row">
			<div class="col-sm-8 offset-sm-2">
				<form action="../controllers/process_add_item.php" method="POST" enctype="multipart/form-data" class="p-5">
					...
					<button type="submit" class="btn btn-block">Add New Item</button>
				</form> <!-- end form -->
			</div> <!-- end 8 cols -->
		</div> <!-- end row -->
	</section>
